    ...
    <div class="header__menu header-menu wrap">
        ...
        <form class="header-menu__search">
            <div class="header-menu__search-wrapper">
                ...
                <input required id="search_bar" name="search_bar" type="text" class="header-menu__search-input" placeholder="Введите название товара">
				<small class="form-text text-danger feedback admin-add__feature-feedback"></small>
                <button id="search_bar__button" class="header-menu__search-submit" disabled>
                    <span>Поиск</span>
                </button>
            </div>
        </form>
                ...
                <div class="swiper-wrapper swiper-aside__wrapper">
                  ...
                  <span class="nav-list__item__img">
                    <img src="/images/submenu-main-6.jpg" alt="SSD-диски">
                        ...
                        <li class="nav-list__item">
                            <button class="nav-list__item-link js-get" data-id="power_block">
                  <span class="nav-list__item__img">
...
<script defer src="../../js/api/search.js"></script>
<script defer src="../../js/api/search_validate.js"></script>
