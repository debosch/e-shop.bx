...
<section class="admin-add">
	<div class="wrap admin-contents__wrap wrap--admin">
		<h1 class="admin-add__title">Добавление товаров</h1>
		<form class="admin-add__form">
			...
			<div class="admin-add__feature">
				...
				<textarea class="admin-add__feature-input Check" type="text" id="cinfo" name="cinfo" rows="5"></textarea>
				<small class="admin-add__feature-feedback"></small>
			</div>

			<div class="admin-add__feature">
				<label for="info" class="admin-add__feature-label">Полное описание</label>
				<textarea class="admin-add__feature-input Check" type="text" id="info" name="info" rows="5"></textarea>
			</div>
			...
			<button  id="admin-add" class="button admin-add__form-button" name="button_add" id="button_add" disabled>Добавить товар</button>
		</form>
	</div>
</section>
...
<script defer src='../../js/admin/admin-images.js'></script>
<script src='../../js/admin/admin-add.js'></script>