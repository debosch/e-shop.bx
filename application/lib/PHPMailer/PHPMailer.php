...
class PHPMailer
{
	 ...
	 *
	 */
	public function addAttachment($path, $name = '', $encoding = self::ENCODING_BASE64, $type = '',
	 ...
	 *
	 */
	public function addStringAttachment($string, $filename, $encoding = self::ENCODING_BASE64, $type = '',
										$disposition = 'attachment')
	{
		try
		{
	 ...
	 *
	 */
	public function addEmbeddedImage($path, $cid, $name = '', $encoding = self::ENCODING_BASE64, $type = '',
									 $disposition = 'inline')
	{
		try
		{
	 ...
	 *
	 */
	public function addStringEmbeddedImage($string, $cid, $name = '', $encoding = self::ENCODING_BASE64, $type = '',
										   $disposition = 'inline')
	{
		try
		{
	...
	public function DKIM_Sign($signHeader)
	{
		...
		$privKeyStr = !empty($this->DKIM_private_string)
			? $this->DKIM_private_string : file_get_contents(
				$this->DKIM_private
			);
